...
## [0.8.0](https://github.com/librasn/compiler/compare/rasn-compiler-v0.7.5...rasn-compiler-v0.8.0) - 2025-03-07
...
- *(generator)* use single underscore in kebab to snake case conversion
