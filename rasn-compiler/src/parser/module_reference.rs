...
mod tests {
    ...
    use crate::parser::module_reference::{module_reference, imports};
        ...
        ModuleReference { 
            ...
            imports: vec![
                Import { 
                    ...
                    origin_identifier: ObjectIdentifierValue(vec![
